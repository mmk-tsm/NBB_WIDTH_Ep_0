...
#define MB_SSIF_START       (0)
#define MB_SSIF_END         (39)



// Defs for read summary message
#define SSIF_SUMMARY_START       (MB_SSIF_START)
#define SSIF_SUMMARY_END         (MB_SSIF_END)

// Defs for write commands message
#define SSIF_COMMANDS_START          (MB_SSIF_START)
#define SSIF_COMMANDS_END            (9)

#define SSIF_TABLE_READ_SIZE         (SSIF_SUMMARY_END - SSIF_SUMMARY_START)
