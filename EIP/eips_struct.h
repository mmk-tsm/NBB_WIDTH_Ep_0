...
/* 0023 */  uint32 O2T_RPI;
/* 0025 */  uint16 O2T_connection_parameters;
/* 0029 */  uint32 T2O_RPI;
/* 0031 */  uint16 T2O_connection_parameters;
/* 0032 */  uint8  xport_type_and_trigger;
/* 0033 */  uint8  connection_path_size;
/* 0097 */  uint16 connection_path[32];
/* 0101 */  uint32 O2T_API;
/* 0105 */  uint32 T2O_API;

  /* Connection Variables (not in ForwardOpen) */
/* 0106 */  uint8  state;
/* 0110 */  uint32 SessionID;
/* 0112 */  uint16 O2T_TimerNum;
/* 0114 */  uint16 O2T_SeqNum;
/* 0116 */  uint16 T2O_TimerNum;
/* 0118 */  uint16 T2O_SeqNum;
...
/* ====================================================================
   CREATE SERVICE CODE STRUCT
======================================================================= */
#define MAX_ATTR_VAL_PAIRS	16
typedef struct
{
	uint16 AttrNum;
	uint16 AttrVal;
	/* EB TODO How to define Object/Class attr-specific Struct */
}CONN_PARAMS_STRUCT;

typedef struct
{
	uint16 ConnectionFlags;
	uint16 NumConnParams;
	CONN_PARAMS_STRUCT ConnParams[MAX_ATTR_VAL_PAIRS];
}CREATE_CIP_SC_STRUCT;
...
typedef struct
{
  ...
  struct
  {
/* ATTR 01 */ uint32  Status;
/* ATTR 02 */ uint32  CfgCapability;
/* ATTR 03 */ uint32  CfgControl;
