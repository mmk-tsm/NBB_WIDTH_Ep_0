...
static void local_ListIdentity(EIPS_ENCAP_MSG_STRUCT *EncapReq, EIPS_SOCKET_STRUCT *sock)
{
    ...
    */
    ...
    rta_PutLitEndian16(eips_IDObj.Inst.Status, resp_msg + resp_msg_siz);
    resp_msg_siz += 2; /* advance the count by the 2 bytes added */
    ...
    resp_msg[resp_msg_siz++] = RTA_MIN(EIPS_USER_IDOBJ_NAME_SIZE, EIPS_STRUCT_MAX_PROD_NAME_SIZE);
    rta_ByteMove((resp_msg+resp_msg_siz), (uint8*)EIPS_USER_IDOBJ_NAME, RTA_MIN(EIPS_USER_IDOBJ_NAME_SIZE, EIPS_STRUCT_MAX_PROD_NAME_SIZE));
    resp_msg_siz += RTA_MIN(EIPS_USER_IDOBJ_NAME_SIZE, EIPS_STRUCT_MAX_PROD_NAME_SIZE);
...
static void local_UnregisterSession(EIPS_ENCAP_MSG_STRUCT *EncapReq, EIPS_SOCKET_STRUCT *sock)
{
    ...
    */
    ...
    /* No Response */
    eips_usersock_tcpClose(sock->sock_id);
