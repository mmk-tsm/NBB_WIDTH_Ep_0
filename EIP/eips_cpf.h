...
#define EIPS_CPF_MAX_ITEM_DATA_LEN  500
#define EIPS_CPF_MAX_RSP_SIZ	    1500
...
#define CIP_SC_ERROR_RESPONSE      0x94
   ...
   #define CIP_SC_EXECUTE_PCCC     0x4B
#endif   

/* Connection Manager Services (PDU) */
#define CIP_SC_FWD_OPEN_REQ        0x54    /* Open	a connection */
